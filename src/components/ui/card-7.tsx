  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group relative w-full h-full overflow-hidden rounded-xl border border-border bg-card shadow-lg",
      ...
      >
        ...
        <div className="relative flex h-full flex-col justify-between p-6 text-card-foreground">
          {/* Top Section: Logo */}
          <div className="flex h-1/3 items-start">
             {logo && (
          ...
          <div className="space-y-4 transition-transform duration-500 ease-in-out group-hover:-translate-y-16">
            ...
            <div>
              <h4 className="font-semibold text-white/90 uppercase text-xs tracking-wider">Overview</h4>
